...
const Valors = () => {
  const circles = [
    ...
    { defaultText: 'Valor 2', hoverText: 'Lorem Ipsum Dolor Sit Amet' },
    { defaultText: 'Valor 3', hoverText: 'Lorem Ipsum Dolor Sit Amet' },
    { defaultText: 'Valor 4', hoverText: 'Lorem Ipsum Dolor Sit Amet' },
    { defaultText: 'Valor 5', hoverText: 'Lorem Ipsum Dolor Sit Amet' },
    { defaultText: 'Valor 6', hoverText: 'Lorem Ipsum Dolor Sit Amet' },
  ]
