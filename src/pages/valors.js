...
const Valors = () => {
  const circles = [
    ...
    { defaultText: 'Girona', hoverText: 'Estimem Girona i la seva gent. Per això treballem per promoure la representació teatral a la ciutat i interpretat a través de la seva gent, sempre obert a tothom qui hi vulgui participar.' },
