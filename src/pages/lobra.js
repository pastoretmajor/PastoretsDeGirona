...
const Lobra = () => {
  const boxes = [
    ...
    { textColor: '#F1F1F1', backgroundColor: '#D91E01', text: "Pastorets ha estat la porta d'entrada al món del teatre d'actors, actrius i tècnics que després han fet el pas al món professional i una escola per a generacions d'aficionats al món del teatre" },
    { textColor: '#F1F1F1', backgroundColor: '#414141', text: 'Els nous Pastorets continuaran essent de caire familiar i musical amb un format diferent, inclusiu i innovador.' },
  ];
  ...
  return (
    <div>
      ...
      <ColoredBox textColor="#F1F1F1" backgroundColor="#D91E01" text="A través de la seva trama, Pastorets de Girona transmeten valors com l'amistat i la solidaritat." />
